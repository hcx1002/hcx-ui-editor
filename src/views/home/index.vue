<template>
  <div class="home">
    ...
    <section class="operation">
      ...
      <!-- 手机 -->
      <div class="phone">
        <div class="w-[375px] h-[667px] m-auto relative">
          <div
            class="absolute z-1 -right-1 top-16 bg-black h-16 w-1 rounded-2xl"
          ></div>
          <div
            class="absolute z-1 -right-1 top-40 bg-black h-10 w-1 rounded-2xl"
          ></div>

          <section
            class="phoneAll flex flex-col w-full h-full border-4 border-black rounded-2xl bg-gray-50 overflow-hidden relative"
            ref="imageTofile"
            id="imageTofile"
          >
            <div class="w-full relative">
              <img src="@/assets/images/phoneTop.png" alt="" class="w-full" />
              <div
                class="absolute left-[50%] translate-x-[-50%] top-0 z-1 bg-black w-[35%] h-full rounded-br-xl rounded-bl-xl"
              ></div>
            </div>
            ...
            <!-- 主体内容 -->
            <section
              class="phone-container flex-1 overflow-y-auto"
              :style="{
...
const choose = reactive({
  ...
  currentproperties: datas.pageSetup as any, // 当前属性  默认：页面设置
